...
describe 'SemanticFormBuilder#commit :as => :input' do
  ...
  before do
    ...
    semantic_form_for(@new_post) do |builder|
      concat(builder.commit :as => :input)
    end
  end
  ...
  it 'should render an input' do
    output_buffer.should have_tag('li.commit input')
  end
  
  it 'should render an input with a type of submit' do
    output_buffer.should have_tag('li.commit input[@type="submit"]')
  end
  
  it 'should render an input with name attribute of "commit"' do
    output_buffer.should have_tag('li.commit input[@name="commit"]')
  end
  
  it "should render an input with the text as the value" do
    output_buffer.should have_tag('li.commit input[@value="Update Post"]')
  end
  ...
  describe 'when access key is nil' do
    it "should not have an accesskey" do
      ...
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit('text', :as => :input, :button_html => {}))
      end
  ...
  describe 'when access key is set through options' do
    it 'should use the value set in options over the default' do
      ...
      @new_post.stub!(:new_record?).and_return(false)
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit('text', :as => :input, :accesskey => 'o'))
      end
  ...
  describe "when accesskey is set through :button_html option" do
    it 'should use the value set in button_html' do
      ...
      @new_post.stub!(:new_record?).and_return(false)
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit('text', :as => :input, :accesskey => 'o', :button_html => {:accesskey => 't'}))
      end
      output_buffer.should_not have_tag('li.commit input[@accesskey="s"]')
  ...
  describe "when :button_html options are provided" do
    ...
    before do
      ...
      @new_post.stub!(:new_record?).and_return(false)
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit('text', :as => :input, :button_html => {:class => 'my_class', :id => 'my_id', :value => "foo", :type => "bah", :name => "baz"}))
      end
    end
    ...
    it 'should pass the :value to the button' do
      output_buffer.should have_tag('li.commit input[@value="foo"]') 
    end
    
    it 'should pass the :type to the button' do
      output_buffer.should have_tag('li.commit input[@type="bah"]')
    end
    
    it 'should pass the :name to the button' do
      output_buffer.should have_tag('li.commit input[@name="baz"]')        
    end
  ...
  describe 'when the first option is a string and the second is a hash' do
    ...
    before do
      @new_post.stub!(:new_record?).and_return(false)
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit("a string", :as => :input, :button_html => { :class => "pretty"}))
      end
    end
  ...
  describe 'when the first option is a hash' do
    ...
    before do
      @new_post.stub!(:new_record?).and_return(false)
      semantic_form_for(@new_post) do |builder|
        concat(builder.commit(:as => :input, :button_html => { :class => "pretty"}))
      end
    end
      ...
      describe 'when explicit label is provided' do
        it 'should render an input with the explicitly specified label' do
          semantic_form_for(:post, :url => 'http://example.com') do |builder|
            concat(builder.commit("Click!", :as => :input))
          end
